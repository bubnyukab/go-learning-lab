...
Hello World
Integers
 Try each exercise BEFORE looking at answers
 Read 2 chapters of The Pragmatic Programmer
 Apply 1 idea to your code
Day 4
 Learn Go with Tests:
Arrays & slices
 Build small example (custom list tool)
 Read 2 chapters of Pragmatic Programmer
...
Day 15
 ...
 Revisit Effective Go (specific sections)
Day 16
 Improve performance or structure
 Refactor using Pragmatic Programmer ideas
Day 17
 Optional: Start Beej's Guide to Network Programming (only if needed)
 OR expand your project instead
Day 18
 Add another feature OR networking concept
 Write clean tests
Day 19
 Final refactor pass
...
testing skills (rare)
solid fundamentals
better coding habits than most beginners
